...
class DataTransformation:
        ...
        try:
            ...
            preprocessor = ColumnTransformer(
                transformers=[
                    ...
                    ("MinMaxScaler", min_max_scaler, mm_columns) #[0,1]
                ],
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            # use normalize (MinMaxScaler) and standardize (StandardScaler) the data
            # first fit_transform on train data, then transform on test data
